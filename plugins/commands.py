...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/Andhra_movies')
            ],
            [
                InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url=f"https://youtube.com/@telugumoviedost7979"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ SUBSCᏒIBΞ ⚡', url='https://youtube.com/@telugumoviedost7979'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Andhra_movies')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 Ma Channel lo Join Avvandi Then Click Try Again 🔥", url=invite_link.invite_link
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**Ee Kindha kanipistunna .....Ma Channel lo Join Avvandi Then Click Try Again..... Button click chesi join avvandi Tarvata Try Again meeda CLick Cheyyandi Meeru Ma Channel Join Avvakunda Try Again Click Chestey ......I Like Your Smartness ...... Ani Vastundhi So 𝑱𝒐𝒊𝒏 𝑶𝒖𝒓 𝑴𝒐𝒗𝒊𝒆 𝑼𝒑𝒅𝒂𝒕𝒆𝒔 𝑪𝒉𝒂𝒏𝒏𝒆𝒍 𝑻𝒐 𝑼𝒔𝒆 𝑻𝒉𝒊𝒔 𝑩𝒐𝒕!**",
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@telugumoviedost7979') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
